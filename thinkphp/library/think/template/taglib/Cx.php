...
class Cx extends Taglib
{
    ...
    protected $tags = [
        ...
        'load'       => ['attr' => 'file,href,type,value,basepath', 'close' => 0, 'alias' => ['import,css,jquery-1.7.2.min.js', 'type']],
    ...
    /**
     * load 标签解析 {load file="/static/jquery-1.7.2.min.js/public.jquery-1.7.2.min.js" /}
