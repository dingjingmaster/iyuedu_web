<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"E:\GitHub\iyuedu_web\/application/novel/view/register.html";i:1535363065;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body  ng-app="register" style="background-color: #FFFAF0">
  ...
  <div ng-cloak ng-controller="registerCtrl" class="register_content">
      ...
      <nobr><p>密&nbsp;&nbsp;码:&nbsp;<input class="reg_input" type="password" ng-model="regPasswd1" placeholder="请输入密码" ng-blur="passwd1_input()"/>&nbsp;&nbsp;<label style="color: #9932CC" ng-model="regPasswd1L">{{regPasswd1L}}</label></p></nobr>
      <nobr><p>密&nbsp;&nbsp;码:&nbsp;<input class="reg_input" type="password" ng-model="regPasswd2" placeholder="请再次输入密码" ng-blur="passwd2_input()"/>&nbsp;&nbsp;<label style="color: #9932CC" ng-model="regPasswd2L">{{regPasswd2L}}</label></p></nobr>
      <br/>
      <div style="margin-left: 98px;" align="center">
          <a ng-click="register_clear()">重置</a>&nbsp;&nbsp;&nbsp;&nbsp;<a ng-click="register_ok()">注册</a>
      </div>
  </div>
